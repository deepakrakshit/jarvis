...
class AppConfig:
    ...
    def from_env(cls, env_path: str = ".env") -> "AppConfig":
        ...
        return cls(
            ...
            tts_chunk_chars=int(os.getenv("TTS_CHUNK_CHARS", "42")),
            ...
            tts_min_sentence_length=int(os.getenv("TTS_MIN_SENTENCE_LENGTH", "16")),
            tts_min_first_fragment_length=int(os.getenv("TTS_MIN_FIRST_FRAGMENT_LENGTH", "14")),
            tts_force_first_fragment_after_words=int(os.getenv("TTS_FORCE_FIRST_FRAGMENT_AFTER_WORDS", "22")),
